...
// ANSWER: O(1) //Only console.log and not returning data as array
...
function getNumbersSquared(numbers) {
  ...
  let numbers2 = numbers.map(squared);
  return numbers2;
}
console.log(getNumbersSquared(numbers2))
...
// ANSWER: Function will return an object with size that varies according to the input string
